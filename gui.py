...
class WideMenu(QMenu):
    def sizeHint(self):
        size = super().sizeHint()
        size.setWidth(size.width() * 2)  # Increase width by 2 times
        return size    
...
class Example(QMainWindow):
    ...
    def initUI(self):
        ...
        toolbar = self.addToolBar('Toolbar')  # Add toolbar
        ...
        toolbar.widgetForAction(startAction).setIconSize(QSize(48, 48))  # Set larger icon size
        ...
        toolbar.widgetForAction(exitAction).setIconSize(QSize(48, 48))  # Set larger icon size
